<script lang="ts">
    ...
    import NftModal from "./NFTModal.svelte";
    import show from "./Modal.svelte";
    import { shown, modalTitle,nftModalDescription,nftModalImage,
        nftModalName,nftModalNftType,nftModalCreator, nftModalExternalUrl,nftModalAttributes } from "../store/nftModal";
    export let nft: NFT;
